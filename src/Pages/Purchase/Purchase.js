...
const Purchase = () => {
    ...
    return (
        <div class="min-h-screen bg-base-200 flex flex-col md:flex-row justify-center items-center gap-10">
            <div class="card w-96 bg-base-100 shadow-lg mt-14 md:mt-0">
                <figure>
